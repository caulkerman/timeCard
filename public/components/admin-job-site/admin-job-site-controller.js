...
function getTheJobSiteFromDBbyId() {// we might want to have this function call for the job site using its own service rather than sending to another
	...
	employeeJobSiteTimeCardService.getTheJobSiteFromDBbyId(jobSiteId).then(function(response) {
		...
		if ($scope.jobsite.length) {//If the job site has some length then call the function.  This avoids an error when the job site has been sent to the old job site pile.
			addAllTheHours();
		};
